...
import com.borges.igreja.repository.PermissaoRepository;
...
public class UsuarioService  implements UserDetailsService {
	...
	public void salvarUsuario(UsuarioModel usuarioModel){
		...
		/*TEMPLO DO USUÁRIO A SER SALVO*/
		usuarioEntity.setTemplo(usuarioModel.getTemplo());
